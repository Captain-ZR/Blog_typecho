                    ...
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <div class="avatar avatar-md">
                                <img src="<?php $this->options->timePageIcon() ?>" alt="..." class="avatar-img rounded">
                            </div>
                        </div>
                        <div class="col">
                            <p class="h5">点点滴滴</p>
            ...
            <a href="<?php $this->options->albumPageLink() ?>" class="card ">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <div class="avatar avatar-md">
                                <img src="<?php $this->options->albumPageIcon() ?>" alt="..." class="avatar-img rounded">
                            </div>
                        </div>
                        <div class="col">
                            <p class="h5">相册</p>
            ...
            <a href="<?php $this->options->loveListPageLink() ?>" class="card ">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <div class="avatar avatar-md">
                                <img src="<?php $this->options->loveListPageIcon() ?>" alt="..." class="avatar-img rounded">
                            </div>
                        </div>
                        <div class="col">
            ...
            <a href="<?php $this->options->blessingPageLink() ?>" class="card ">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <div class="avatar avatar-md">
                                <img src="<?php $this->options->blessingPageIcon() ?>" alt="..." class="avatar-img rounded">
                            </div>
                        </div>
                        <div class="col">
                            <p class="h5">祝福板</p>
            ...
            <a href="<?php $this->options->aboutPageLink() ?>" class="card ">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <div class="avatar avatar-md">
                                <img src="<?php $this->options->aboutPageIcon() ?>" alt="..." class="avatar-img rounded">
                            </div>
                        </div>
                        <div class="col">
                            <p class="h5">关于我们</p>
